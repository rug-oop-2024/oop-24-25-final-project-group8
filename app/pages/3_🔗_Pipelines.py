...
class PipelinesPage:
    def __init__(self) -> None:
        """Initialize PipelinesPage with AutoMLSystem instance and load pipeline artifacts."""
        ...
        self.artifacts = [artifact for artifact in self.automl.registry.list() if artifact.type == "pipeline"]
