...
class LogisticRegressionModel(Model):
    """
    Wrapper around scikit-learn's LogisticRegression, integrating it with the Model interface.
    ...
    def _validate_fit(self) -> None:
        """
        Check if the model has been fitted by verifying the presence of learned parameters.
